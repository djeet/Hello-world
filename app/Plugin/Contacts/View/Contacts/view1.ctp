...
<div class="firstN left">
    <?php echo $this->Form->input('Message.fname', array('type' => 'text','label' => '','class'=>'','div'=>'','value'=>'','style'=>'display: inline-block; margin-right:0;')); ?>
...
<div class="lastN right">
    <?php //echo $this->Form->input('Message.lname', array('type' => 'text','label' => '','class'=>'','div'=>'','value'=>'','style'=>'display: inline-block; margin-right:-30px; margin-left:5px;')); ?>
...
<div class="FormField right">
   <?php echo $this->Form->input('Message.title', array('type' => 'text','label' => '','class'=>'','div'=>'','value'=>'','style'=>'')); ?>
</div>
<div class="clear"></div>
</div>
<div class="clear"></div>
...
<div class="FormField right">
    <?php echo $this->Form->input('Message.body', array('type' => 'text','label' => '','class'=>'','div'=>'','value'=>'','style'=>'')); ?>
</div>
<div class="clear"></div>
</div>
