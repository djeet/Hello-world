         ...
         <div class="recommendVenue">
            ...
            <div align="center" style="width:auto">
               <div class="recommendFunctVenue">
                   <?php if (!empty($nodesn[0]['Node']['title'])) { ?>
                   <a href="#">
                       <?php //echo $this->Html->image($nodesn[0]['Nodeattachment']['path'], array('alt' => '', 'width' => '160', 'height' => '100')); ?>
                     <?php echo $this->Html->image('venue/images/venue1.png', array('width' => '160', 'height' => '100')) ?>
               ...
               <div class="recommendFunctVenue">
                   <?php if (!empty($nodesn[1]['Node']['title'])) { ?>
                   <a href="#">
                       <?php //echo $this->Html->image($nodesn[1]['Nodeattachment']['path'], array('alt' => '', 'width' => '160', 'height' => '100')); ?>
                     <?php echo $this->Html->image('venue/images/venue1.png', array('width' => '160', 'height' => '100')) ?>
               ...
               <div class="recommendFunctVenue">
                   <?php if (!empty($nodesn[2]['Node']['title'])) { ?>
                   <a href="#">
                       <?php //echo $this->Html->image($nodesn[2]['Nodeattachment']['path'], array('alt' => '', 'width' => '160', 'height' => '100')); ?>
                     <?php echo $this->Html->image('venue/images/venue1.png', array('width' => '160', 'height' => '100')) ?>
               ...
               <div class="recommendFunctVenue">
                   <?php if (!empty($nodesn[3]['Node']['title'])) { ?>
                   <a href="#">
                       <?php //echo $this->Html->image($nodesn[3]['Nodeattachment']['path'], array('alt' => '', 'width' => '160', 'height' => '100')); ?>
                     <?php echo $this->Html->image('venue/images/venue1.png', array('width' => '160', 'height' => '100')) ?>
               ...
               <div class="recommendFunctVenue">
                   <?php if (!empty($nodesn[4]['Node']['title'])) { ?>
                   <a href="#">
                       <?php //echo $this->Html->image($nodesn[4]['Nodeattachment']['path'], array('alt' => '', 'width' => '160', 'height' => '100')); ?>
                     <?php echo $this->Html->image('venue/images/venue1.png', array('width' => '160', 'height' => '100')) ?>
