...
//                  echo "Longitude : " . 
            ...
            <div class="destDeatilsTable right" style="min-height:357px;"> 
               <div class="InnerTable" style="min-height:254px;">
...
<?php if (!empty($node_query[0]['Node']['title'])) { ?>
      ...
      <div class="wrapper">
         ...
         <div class="recommendVenue">
            ...
            <div align="center" style="width:auto">
               ...
               <div class="HeadingBlueBg">Recommended Venues</div>
            ...
            <div align="center" style="width:auto">
               <div class="recommendFunctVenue">
                   <?php if (!empty($node_query[0]['Node']['title'])) { ?>
                   <a href="#">
                       <?php echo $this->Html->image($node_query[0]['Nodeattachment'][0]['path'], array('alt' => '', 'width' => '160', 'height' => '100')); ?>
                     <?php //echo $this->Html->image('venue/images/venue1.png', array('width' => '160', 'height' => '100')) ?>

                  </a>
                  <p><a class="font16 " href="<?php echo $node_query[0]['Node']['title']; ?>"><?php echo $node_query[0]['Node']['title'] ?></a></p>
                    <?php } ?>
               </div>

               <div class="recommendFunctVenue">
                   <?php if (!empty($node_query[1]['Node']['title'])) { ?>
                   <a href="#">
                       <?php echo $this->Html->image($node_query[1]['Nodeattachment'][0]['path'], array('alt' => '', 'width' => '160', 'height' => '100')); ?>
                     <?php //echo $this->Html->image('venue/images/venue1.png', array('width' => '160', 'height' => '100')) ?>

                  </a>
                  <p><a class="font16 " href="<?php echo $node_query[1]['Node']['title']; ?>"><?php echo $node_query[1]['Node']['title'] ?></a></p>
                    <?php } ?>
               </div>
               <div class="recommendFunctVenue">
                   <?php if (!empty($node_query[2]['Node']['title'])) { ?>
                   <a href="#">
                       <?php echo $this->Html->image($node_query[2]['Nodeattachment'][0]['path'], array('alt' => '', 'width' => '160', 'height' => '100')); ?>
                     <?php //echo $this->Html->image('venue/images/venue1.png', array('width' => '160', 'height' => '100')) ?>

                  </a>
                  <p><a class="font16 " href="<?php echo $node_query[2]['Node']['title']; ?>"><?php echo $node_query[2]['Node']['title'] ?></a></p>
                    <?php } ?>
               </div>
               <div class="recommendFunctVenue">
                   <?php if (!empty($node_query[3]['Node']['title'])) { ?>
                   <a href="#">
                       <?php echo $this->Html->image($node_query[3]['Nodeattachment'][0]['path'], array('alt' => '', 'width' => '160', 'height' => '100')); ?>
                     <?php //echo $this->Html->image('venue/images/venue1.png', array('width' => '160', 'height' => '100')) ?>

                  </a>
                  <p><a class="font16 " href="<?php echo $node_query[3]['Node']['title']; ?>"><?php echo $node_query[3]['Node']['title'] ?></a></p>
                    <?php } ?>
               </div>
               <div class="recommendFunctVenue">
                   <?php if (!empty($node_query[4]['Node']['title'])) { ?>
                   <a href="#">
                       <?php echo $this->Html->image($node_query[4]['Nodeattachment'][0]['path'], array('alt' => '', 'width' => '160', 'height' => '100')); ?>
                     <?php //echo $this->Html->image('venue/images/venue1.png', array('width' => '160', 'height' => '100')) ?>

                  </a>
                  <p><a class="font16 " href="<?php echo DOMAIN_NAME/$node_query[4]['Node']['title']; ?>"><?php echo $node_query[4]['Node']['title'] ?></a></p>
                    <?php } ?>
               </div>
               <div class="clear"></div>
            </div>
