			...
			<?php foreach ($nodes as $node): ?>
				<tr>
					...
					<td>
						...
						<span class="label label-info"><?php echo __('Featured'); ?></span>
                                                <?php endif ?>
                                                <?php if ($node['Node']['parent_id'] == '' && $node['Node']['type'] == 'node'): ?>
						<span class="label label-info" style="color:red;"><?php echo __('Main Post'); ?></span>
						<?php endif ?>
					</td>
					<td>
