...
<div class="contact-form">
	<?php
		...
		echo $this->Form->input('Nodes.name', array('label' => __('Your name')));
		echo $this->Form->input('Nodes.email', array('label' => __('Your email')));
		echo $this->Form->input('Nodes.title', array('label' => __('Subject')));
		echo $this->Form->input('Nodes.body', array('label' => __('Message')));
