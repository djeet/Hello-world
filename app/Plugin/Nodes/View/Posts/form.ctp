...
<div class="fullWidth grey-color"> <!-- Page Content Full Width(Contact)-->
  <div class="wrapper">
<?php echo $this->Form->create('Post',array('controller'=> 'posts', 'action' => 'form'));?>
...
<?php //echo $this->Form->create('Post',array('enctype'=>'multipart/form-data','type'=>'post',array('url'=>array('controller'=>'posts','action'=>'form'))));?>
<div class="VenueFormRow">
<label class="left"> Name <span> * </span></label>
<div class="FormField right">
<div class="firstN left">
    <?php //echo $this->Form->input('Post.fname', array('type' => 'text','label' => __(''), 'display' => 'inline-block','margin-right' => '0' )); ?>
...
<div class="lastN right">
    <?php //echo $this->Form->input('Post.lname', array('label' => __(''), 'display' => 'inline-block','margin-right' => '0','margin-left' => '5' )); ?>
...
<div class="FormField right">
    <?php //echo $this->Form->input('Post.email', array('label' => __(''))); ?>
<input type="text" name=""/></div>
    <div class="clear"></div>
</div>
<div class="clear"></div>
...
<div class="FormField right">
    <?php //echo $this->Form->input('Post.best_cell', array('label' => __(''))); ?>
<input type="text" name=""/></div>
<div class="clear"></div>
</div>
<div class="clear"></div>
...
<div class="FormField right">
    <?php //echo $this->Form->input('Post.best_time', array('label' => __(''))); ?>
<input type="text" name=""/></div>
<div class="clear"></div>
</div>
