...
<!--               <a href="javascript:void(0)" data-value="birthday-party">Birthday Party</a>
               ...
               <?php 
                    ...
                    ?>
<!--                       <a href="javascript:void(0)" data-value="birthday-party"><?php //echo $value['Category']['name'] ?></a><br>    -->
<!--                       <li> 
    ...
    <div class="wrapper">
      ...
      <div class="clear"></div>
        ...
        <div class="left single-collection" >
            <div class="single-collection-heading darkblue-color"><?php echo $this->Layout->node('title') ?></div>
            <div class="single-collection-venues text-color"> 12 venues </div>
            <hr color="#dddddd"/>
            <div class="single-collection-large-image"><?php echo $this->Html->image($image,array('alt'=>'', 'class'=>'', 'width' => '225', 'height' => '143'));?></div>
           <div class="single-title-strip"> Docklands </div>
            <hr color="#dddddd"/>
            <div class="up-from-strip">
            <div class="left up-to text-color"> Up to 350</div>
            <div class="right from-strip text-color"><?php //echo $node['Taxonomy'][1]['Term']['title'];//$this->Layout->node('Taxonomy.[0].Term.title'); ?></div>
            <div class="clear"></div>
            </div>
            <div class="clear"></div>
          </div>
